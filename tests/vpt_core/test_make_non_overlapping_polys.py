...
Make_non_Overlapping_Cases = [
    ResolveOverlapCase(name="empty", segmentation=SegmentationResult(), result=SegmentationResult()),
    ResolveOverlapCase(
        name="no_overlap",
    ...
    ResolveOverlapCase(
        ...
        segmentation=from_shapes_3d(
            [
                [Square(0, 0, 20), Square(1, 1, 20)],
        ...
        result=from_shapes_3d(
            [
                [
                    Square(0, 0, 20).difference(Square(13, 13, 14)),
                    Square(1, 1, 20).difference(Square(13, 13, 14)),
                ],
                [Square(15, 15, 10), Square(15, 15, 10)],
            ]
        ),
    ...
    ResolveOverlapCase(
        ...
        result=from_shapes([Rect(0, 0, 7, 10), Rect(9, 10, 9, 4), Square(9, 0, 8)]),
    ),
]
