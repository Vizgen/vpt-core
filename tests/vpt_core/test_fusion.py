...
from vpt_core.utils.segmentation_utils import (
    Rect,
    Square,
    assert_seg_equals,
    from_shapes_3d,
...
FUSE_TASKS_CASES = [
    TasksFusionCase(
        ...
        fusion_parameters={"cell": SegFusion("harmonize", {"min_distance_between_entities": 1, "min_final_area": 5})},
    ...
    TasksFusionCase(
        ...
        fusion_parameters={"cell": SegFusion("harmonize", {"min_distance_between_entities": 1, "min_final_area": 5})},
        result=from_shapes_3d(
            [[Square(0, 0, 10)], [Rect(40, 0, 12, 10)], [Square(19, -1, 12)]],
    ...
    TasksFusionCase(
        name="union_strategy",
        seg_results=[
            from_shapes_3d([[Square(20, 20, 10)], [Square(20, 38, 10)]]),
            from_shapes_3d([[Square(20, 16, 13)], [Square(16, 38, 13)]]),
        ],
        fusion_parameters={"cell": SegFusion("union", {"min_distance_between_entities": 1, "min_final_area": 5})},
        result=from_shapes_3d([[Rect(20, 18, 13, 17)], [Rect(18, 38, 17, 13)]], cids=[100000, 200001]),
    ),
    TasksFusionCase(
        name="larger_strategy",
        seg_results=[
            from_shapes_3d([[Square(20, 20, 10)], [Square(20, 38, 15)]]),
            from_shapes_3d([[Square(12, 12, 13)], [Square(20, 39, 10)]]),
        ],
        fusion_parameters={"cell": SegFusion("larger", {"min_distance_between_entities": 1, "min_final_area": 5})},
        result=from_shapes_3d([[Square(12, 12, 13)], [Square(20, 38, 15)]], cids=[200000, 100001]),
    ),
    TasksFusionCase(
        name="one_seg_result",
        seg_results=[
        ...
        fusion_parameters={"cell": SegFusion("harmonize", {"min_distance_between_entities": 1, "min_final_area": 5})},
        result=from_shapes_3d([[Square(20, 20, 10)], [Square(20, 38, 15)]], cids=[100000, 100001]),
    ),
]
...
def test_z_line_fusion(case: ZFusionCase) -> None:
    case.seg_result.fuse_across_z(coverage_threshold=0.7)
...
def test_tasks_fusion(case: TasksFusionCase) -> None:
    case.seg_results = SegmentationResult.reindex_by_task(case.seg_results, list(range(len(case.seg_results))))
...
def test_unsupported_strategy() -> None:
    try:
        fuse_task_polygons([from_shapes_3d([[Square(0, 0, 10)]])], SegFusion("random"))
        assert False
    except Exception:
        return
